...
async function findStudentGameMarks(studentId) {
   ...
   const stdnt = await getUserByIdLocal(studentId);
    ...
    const response = {
        ...
        game2Badge2Shared: result.module1.game2.badge2Shared,
        game2Badge3Shared: result.module1.game2.badge3Shared,
        ...
        game3Badge2Shared: result.module1.game3.badge2Shared,
        game3Badge3Shared: result.module1.game3.badge3Shared,
        ...
        game4Badge2Shared: result.module1.game4.badge2Shared,
        game4Badge3Shared: result.module1.game4.badge3Shared,
...
module.exports = { getGameDetails , findStudentGameMarks , defineStudentTaskStructure , calculateTotalMarks ,formatDate , shareBadge , findAllStudentsGameMarks};